...
import BoxMaster from './BoxMaster'
...
const ProjectInfo = () => {
  return (
    <div className=' w-[91.25rem] h-[38.125rem] border-[#CAD4D5] border-[0.0625rem] shadow-[-0.39291625rem_-0.39291625rem_0.78583125rem_0.196458125rem_#FFFFFF,0.39291625rem_0.39291625rem_0.78583125rem_#BABFBF] rounded-[0.98125rem] overflow-hidden'>
        <div className='w-full h-[3.75rem] border-[#DCE3E3] border-[0.0625rem] shadow-[-0.285380625rem_-0.285380625rem_0.456609375rem_#FFFFFF,0.285380625rem_0.285380625rem_0.399533125rem_#B6C3C5] flex items-center gap-[1.25rem]'>
        ...
        <div className='w-[86.0625rem] flex justify-center mx-auto'>
            <div className='w-[48.3125rem] h-[34.71875rem] mt-[0.725rem]'>
                <div className='flex w-[42.225625rem] justify-between'>
                    <div className='w-[26.875rem]'>
                        <div className='text-grade1 text-[1.875rem] font-[600]'>
                            SOCIETY HOUSE
                        </div>
                        <div className='mt-[0.7rem] text-grade text-[1.25rem] font-[600] leading-[1.60375rem] w-[27.4375rem]'>
                            Where Culture, Business, and Iconic Landmarks Collide in Electrifying Harmony
                        </div>
                        <div className='flex  items-center justify-between w-full mt-[0.6125rem]'>
                            <div className='w-max gap-[0.441875rem] items-center justify-between flex'>
                    ...
                    <div className='h-[4.8075rem] w-[8.125rem] border-[#DCE3E3] border-[0.0625rem] rounded-[0.26875rem] shadow-[-4.14591px_-4.14591px_4.72709px_#FFFFFF,3.15139px_3.15139px_4.72709px_#B6C3C5] flex justify-center items-center mt-[0.5rem]'>
                        <img src={devlogo} alt="" />
                    </div>
                    ...
                    <div className='w-[42.225625rem]  h-[21.606875rem] flex flex-wrap gap-x-[3.173125rem] gap-y-[2.018125rem] mt-[1.564375rem]'>
                        <BoxMaster
                            BoxType='standerd'
                            // flipType='zibra'
                            boxArgs={
            ...
            <div className='h-[38.125rem] z-[2] relative mt-[-3.75rem] ml-[5.25rem]'>
                <InElementSeperator width='0.375rem'/>
            </div>
            <div className='w-[41.125rem] ml-[5.25rem] shadow-[inset_-0.3125rem_-0.3125rem_0.5rem_#FFFFFF,inset_0.3125rem_0.3125rem_0.4375rem_#B6C3C5] h-[29.5625rem] rounded-[0.9375rem] mt-[2.75rem] flex flex-col items-center justify-center '>
