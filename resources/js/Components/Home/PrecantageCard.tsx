...
const PrecantageCard = () => {
  return (
    <div className='lg:w-[9.375rem] lg:h-[11.5625rem] w-[45%] bg-[#E6EDED] rounded-[0.6rem] border-[#DCE3E3] border-[0.0625rem] shadow-[-0.525168125rem_-0.525168125rem_0.598786875rem_#FFFFFF,0.39919125rem_0.39919125rem_0.598786875rem_#B6C3C5] flex flex-col items-center overflow-hidden'>
